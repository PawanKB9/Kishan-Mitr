...
import fs from 'fs';
import { comparePassword, generateToken, hashPassword } from '../Auth/UserAuth.js';
...
export const signUp = async (req, res) => {
  try {
    ...
    const { name, password, phone, location, shopName } = req.body;
...
// update user (name ,shopName , location)
